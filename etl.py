...
def process_song_file(cur, filepath):
    ...
    """
    Processes a given song file and loads it into the database.
    """ 
...
def process_log_file(cur, filepath):
    """
    Processes a given log file and loads it into the database.
    """
    # open log file
    df = pd.read_json(filepath,lines=True)
    ...
    for index, row in df.iterrows():
        ...
        songplay_data = [starttime, row.userId,
...
def process_data(cur, conn, filepath, func):
    ...
    """
    Processes each data file in a given filepath accessing each file.
    """
